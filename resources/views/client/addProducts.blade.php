                            ...
                            <div class="mask d-flex align-items-center h-100 gradient-custom-3">
                                ...
                                <div class="row d-flex justify-content-center align-items-center h-100">
                                    ...
                                    <div class="card" style="border-radius: 15px;">
                                        ...
                                        <form enctype="multipart/form-data" role="form" method="POST" action="{{ route('client.addproducts') }}">
                                            ...
                                            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                                <div class="input-group input-group-alternative mb-3">
                                                    ...
                                                    <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Product Name') }}" type="text" name="product_name" value="{{ old('Product name') }}" required autofocus>
                                                </div>
                                                @if ($errors->has('name'))
                                            ...
                                            <div class="form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                                                <div class="input-group input-group-alternative mb-3">
                                                    ...
                                                    <input class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" placeholder="{{ __('Product Price') }}" type="number" min="0" name="product_price_per_unit" value="{{ old(1) }}" required autofocus>
                                                </div>
                                                @if ($errors->has('price'))
                                                    <span class="invalid-feedback" style="display: block;" role="alert">
                                            ...
                                            <div class="form-group{{ $errors->has('quantity') ? ' has-danger' : '' }}">
                                                <div class="input-group input-group-alternative mb-3">
                                                    ...
                                                    <input class="form-control{{ $errors->has('quantity') ? ' is-invalid' : '' }}" placeholder="{{ __('Product quantity') }}" type="number" min="0" name="product_quantity" value="{{ old(1) }}" required autofocus>
                                                </div>
                                                @if ($errors->has('name'))
                                                    <span class="invalid-feedback" style="display: block;" role="alert">
                                                        <strong>{{ $errors->first('name') }}</strong>
